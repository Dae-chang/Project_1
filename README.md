...
- a태그를 이용하여 클릭하면 해당 사이트로 이동하는 기능 구현
- 메인 페이지 유튜브 삽입
...
#### 메인 페이지 PC, 모바일, 테블릿 모드 css수정

#### 지도 페이지 모바일, 테블릿 모드 css수정 
...
대구의 창 사이트 UI/UX를 작업을 처음 맡게 되어 부담감이 있었던 것 같습니다.
인터페이스 디자인에 대해 이해가 부족해 막막했고 특히 직관적인 디자인 과정에서 고민이 많이 됬습니다. 
하지만 팀원들과 교수님들의 피드백을 받으며 작업하니 조금 나아졌다고 생각했습니다. 
이 경험을 통해 많은 사이트를 둘러봐야 하며 사용자의 목소리를 듣는 것이 중요하다는 것을 깨달았습니다.
